...
class UserSkillResponse(BaseModel):
    ...
    skillCategory: str
    level: int
    experienceYears: Optional[float]
    description: Optional[str]
    ...
    try:
        ...
        user_skills = [
            UserSkillResponse(
                ...
                isVerified=True,
                verifiedAt=(datetime.now() - timedelta(days=30)).isoformat(),
            ...
            UserSkillResponse(
                ...
                isVerified=False,
                verifiedAt=None,
                createdAt=(datetime.now() - timedelta(days=300)).isoformat(),
                updatedAt=(datetime.now() - timedelta(days=15)).isoformat()
            ),
            UserSkillResponse(
                id=3,
                skillId=201,
            ...
            UserSkillResponse(
                ...
                updatedAt=(datetime.now() - timedelta(days=20)).isoformat()
            ),
            UserSkillResponse(
                id=5,
                skillId=401,
                ...
                isVerified=True,
                verifiedAt=(datetime.now() - timedelta(days=60)).isoformat(),
...
async def update_my_skill(
    ...
    try:
        ...
        updated_skill = UserSkillResponse(
            id=user_skill_id,
            skillId=101,  # 模拟技能ID
            skillName="Python",  # 保持原技能名称
            skillCategory="programming",  # 保持原分类
            level=request.level if request.level is not None else 3,
            experienceYears=request.experience_years if request.experience_years is not None else 2.0,
            ...
            isVerified=False,  # 更新后需要重新认证
            verifiedAt=None,
            createdAt=(datetime.now() - timedelta(days=100)).isoformat(),  # 保持原创建时间
            updatedAt=datetime.now().isoformat()
        )
    ...
    try:
        ...
        user_skills = [
            ...
            UserSkillResponse(
                ...
                certificates=[],
                isVerified=True,
                verifiedAt=(datetime.now() - timedelta(days=45)).isoformat(),
                createdAt=(datetime.now() - timedelta(days=200)).isoformat(),
                updatedAt=(datetime.now() - timedelta(days=5)).isoformat()
            )
        ]
    ...
    try:
        ...
        recommended_skills = [
            ...
            SkillResponse(
                ...
                tags=["容器编排", "微服务", "云原生"],
                user_count=167,
                createdAt=(datetime.now() - timedelta(days=80)).isoformat()
            ),
            SkillResponse(
                id=303,
                name="TypeScript",
