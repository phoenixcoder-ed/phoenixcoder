...
const mapDispatchToProps = (_dispatch: (_action: unknown) => unknown) => ({
    fetchTasks: bindActionCreators(taskActions.fetchTasks, _dispatch),
    takeTask: bindActionCreators(taskActions.takeTask, _dispatch),
});
